...
<template>
  <div class="container">
    ...
    <div class="origin-head">
      <img :src="practiceData.xxsButton[2].image" alt="">
      <p>{{practiceData.xxsButton[2].title}}</p>
      <p>文章：{{originData.total}}</p>
    </div>
    <p class="title">
      {{practiceData.xxsButton[2].param.content}}
    </p>
    <div class="hot-new">
  ...
  export default{
    ...
    methods:{
      ...
      fetchData(){
        ...
        axios.post('bevol/user_part/list/lists?p_entity_id=50&sort='+that.sort+'&pager=1&pageSize=10', {},
          {
