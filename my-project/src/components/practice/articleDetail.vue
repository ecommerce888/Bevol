...
<template>
  <div class="container">
    ...
    <div class="main-find" v-html="findData.descp"></div>
...
//            评论数据
        let url = encodeURI('http://api.bevol.cn/entity/comment5/lists/find?id=' + id + '&pager=1&pageSize=20&type=1');
